...
const MonterosaSdkExperienceView = exports.MonterosaSdkExperienceView = _reactNative.UIManager.getViewManagerConfig(ComponentName) != null ? (0, _reactNative.requireNativeComponent)(ComponentName) : () => {
